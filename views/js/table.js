...
function addRow(table_id, param) {
  // table element 찾기
  const table = document.getElementById(table_id); //여기에 테이블 이름 들어가야합니다.
  ...
  for (var key in param) {
    var newCell = newRow.insertCell(i); // 새 행(Row)에 Cell 추가
    newCell.innerText = param[key]; // Cell에 텍스트 추가
    i++;
  }
}
